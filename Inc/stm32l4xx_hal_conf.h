...
/* USER CODE BEGIN CustonDefines */
// Custom stuff added to select the correct QSPI or OSPI module based on the target MCU
#ifdef STM32L475xx
#undef HAL_OSPI_MODULE_ENABLED
#define HAL_QSPI_MODULE_ENABLED
#else // for STM32L4s5xx
#undef HAL_QSPI_MODULE_ENABLED
#define HAL_OSPI_MODULE_ENABLED
#endif

/* USER CODE End CustonDefines */
